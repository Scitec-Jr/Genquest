...
export default async function Home({ params }: { params: Promise<{ locale: Locale }> }) {
	...
	return (
		<main className="max-w-360 mx-auto">
			<section className="flex flex-col-reverse md:flex-row w-full bg-(--main-color)">
                ...
                <div className="flex flex-1">
                    <div className="relative w-full">
                        ...
                        <a href="" className="absolute bottom-8 left-1/2 -translate-x-1/2 w-max p-4 bg-white border-2 rounded-full">{dict.home.clientButton}</a>
                    </div>

                    <div className="relative w-full">
                        <Image src="/assets/images/partner.png" alt="Parceiro" width={200} height={200} className="w-full h-full"/>
                        <a href="" className="absolute bottom-8 left-1/2 -translate-x-1/2 w-max p-4 bg-white border-2 rounded-full">{dict.home.partnerButton}</a>
                    </div>
                </div>
            </section>
