	...
	return (
		<main>
			<section className="bg-(--main-color)">
				<div className="flex flex-col md:flex-row">
					<div className="relative flex flex-col justify-center flex-1 p-4 shadow-[4px_4px_15px_20px_var(--main-color)] z-10">
						<h1 className="mb-4 text3xl md:text-5xl text-(--accent-color) secondary-font">Integração de Ecossistema</h1>

						<p className="mb-4 text-xl text-white">Educação contínua em comércio internacional farmacêutico para:</p>
						<ul className="ps-4 text-xl text-white list-disc">
							<li>Associação de pacientes;</li>
							<li>Profissionais de saúde e centros de referência;</li>
							<li>Gestores de saúde;</li>
							<li>Legisladores e reguladores.</li>
						</ul>
					</div>
					...
					<Carousel showDots={false} leftArrowSrc={"/assets/icons/carouselArrowLeft2.png"} rightArrowSrc={"/assets/icons/carouselArrowRight2.png"}>
						<div className="min-w-full md:min-w-auto md:flex-[0_0_50%] lg:flex-[0_0_33.33%] px-4">
							<div className="p-8 bg-white rounded-4xl text-black">
								...
								<h3>Presidente da casa Hunter</h3>
							</div>
						</div>
			...
			<section className="relative py-8 px-4 md:px-8 bg-white z-20">
				<div className="max-w-360 mx-auto">
					<h2 className="mb-8 text-4xl secondary-font text-(--accent-color) text-center">Parceiros</h2>
					...
					<Carousel autoplay leftArrowSrc={"/assets/icons/carouselArrowLeft2.png"} rightArrowSrc={"/assets/icons/carouselArrowRight2.png"} showDots={false} align="center">
						<div className="flex md:flex-[0_0_50%] lg:flex-[0_0_33.4%] justify-center min-w-full md:min-w-auto p-4">
							<div className="p-4 rounded-xl shadow-md">
								<Image src="/assets/images/partner1.png" alt="FarmaMondo" width={300} height={200} className="w-full mb-4" />
							</div>
						</div>

						<div className="flex md:flex-[0_0_50%] lg:flex-[0_0_33.4%] justify-center min-w-full md:min-w-auto p-4">
							<div className="p-4 rounded-xl shadow-md">
								<Image src="/assets/images/partner2.png" alt="SteinCares" width={300} height={200} className="w-full mb-4" />
							</div>
						</div>

						<div className="flex md:flex-[0_0_50%] lg:flex-[0_0_33.4%] justify-center min-w-full md:min-w-auto p-4">
							<div className="p-4 rounded-xl shadow-md">
								<Image src="/assets/images/partner3.png" alt="Supera" width={300} height={200} className="w-full mb-4" />
							</div>
						</div>
					</Carousel>
				</div>
			...
			<section className="bg-(--accent-color)">
				<div className="flex flex-col md:flex-row">
					<div className="relative flex flex-col justify-center flex-1 px-8 py-4 shadow-[4px_4px_15px_20px_var(--accent-color)] z-10">
						<h1 className="mb-4 text-3xl text-white secondary-font">Entre em contato</h1>

						<a href="mailto:contato@genquest.com.br" className="text-xl">
							<Image src="/assets/icons/mail2.png" alt="Email" width={16} height={16} className="inline-block mr-1" />
							contato@genquest.com.br
						</a>
						<a href="tel:+5511963767888" className="text-xl">
							<Image src="/assets/icons/whatsapp2.png" alt="Phone" width={16} height={16} className="inline-block mr-1" />
							+55 (11) 96376-7888
						</a>
					</div>

					<div className="flex-1">
						<Image src="/assets/images/heroContact.png" alt="Contato" width={500} height={200} className="w-full h-full max-h-60" />
					</div>
				</div>
			</section>
		</main>
